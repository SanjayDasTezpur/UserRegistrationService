package com.my.microservice.config.timezone;

import com.my.microservice.UserRegistrationServiceApp;
import com.my.microservice.repository.timezone.DateTimeWrapper;
import com.my.microservice.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = UserRegistrationServiceApp.class)
